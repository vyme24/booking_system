    ...
    <form action="flight-grid.html">
      <div className="d-flex align-items-center justify-content-between flex-wrap mb-2">
        <div className="d-flex align-items-center flex-wrap">
          {['oneway', 'roundtrip', 'multiway'].map((type) => (
            <div key={type} className="form-check d-flex align-items-center me-3 mb-2">
              ...
              <label className="form-check-label fs-14 ms-2" htmlFor={type}>
                {type === 'oneway' ? 'Oneway' : type === 'roundtrip' ? 'Round Trip' : 'Multi Trip'}
              </label>
            </div>
          ))}
        </div>
              ...
              <div className="form-item dropdown">
                <div data-bs-toggle="dropdown">
                  ...
                  <p className="fs-12 mb-0">
                    {passengers.adults} Adult, {cabinClass}
                  </p>
                </div>
                      ...
                      {cabinClasses.map((cabin) => (
                        <div key={cabin.id} className="form-check me-3 mb-3">
                          <input
                            ...
                            name="cabin-class"
                            id={cabin.id}
                            checked={cabinClass === cabin.id}
                            onChange={() => setCabinClass(cabin.id)}
                          />
